...
Shader "Quantum Theory/PolyWorld SRP - HDRP/PolyWorld SurfaceNoise"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = ( _Color * packedInput.ase_color ).rgb;
...
ASEEND*/
//CHKSM=598378167D59834C802A57A2488B5E731FD798F8